        ...
        return (
                <div className="overflow-hidden"> 
                    ...
                    <div className="col-12 col-md-12 ">
                        <div className="col-xl-6 col-lg-12 col-md-12 AboutFont mt-5 aboutmaxwidth rightfadein">
                            <div>
                        ...
                        <div className="col-xl-6 col-lg-12 col-md-12 aboutmaxwidth leftfadein" >
